new Vue({
    ...
    data: {
       ...
       is_encrypting: 'true',
       message: sisVigenere.getElementByID("vigenere__input"), // y tons ? k asemos ? 
       key: 'Good fortune' // yo tengo un codigo de vigenere pero ps pa colocarlo seria la misma que he estado haciendo xd
    },
    methods: {
